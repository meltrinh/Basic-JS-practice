// Write a function to test if a number is greater than or equal to 10, and is an even number.
// The function returns You found the right number! if two conditions are met.
